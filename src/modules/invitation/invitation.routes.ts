...
router.get("/company", authMiddleware, COMPANY_SIDE, requireVerifiedCompany, companyInvitationsHandler);
router.get("/me", authMiddleware, STUDENT, myInvitationsHandler);

router.post("/", authMiddleware, COMPANY_SIDE, requireVerifiedCompany, validateRequest(createInvitationSchema), createInvitationHandler);
router.patch("/:id/cancel", authMiddleware, COMPANY_SIDE, requireVerifiedCompany, cancelInvitationHandler);
